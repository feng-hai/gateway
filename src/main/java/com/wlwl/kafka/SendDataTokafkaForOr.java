...
public class SendDataTokafkaForOr extends Thread {

	//private BlockingQueue<ProtocolModel> sendQueue;

	private Producer<String, String> producer;

	private static final Logger logger = LoggerFactory.getLogger(SendDataTokafkaForOr.class);

	public SendDataTokafkaForOr() {
